...
import com.univaq.mwt.headlines.data.api.ApiResponse;
...
//                return forceRefresh || !hasData || data == null || data.getArticles().isEmpty();
            ...
            protected Call<ApiResponse> createCall() {
                String country = getPreferences().getString(getAppContext().getString(R.string.settings_country_key), getAppContext().getString(R.string.settings_country_italy_value));
